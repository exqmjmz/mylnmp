FROM alpine:3.8
RUN	apk --update add nginx php7 php7-fpm php7-opcache php7-gd php7-mysqli php7-zlib php7-curl php7-sqlite3 php7-mysqlnd \
...
RUN mkdir -p /run/nginx \
	...
	&& wget "https://github.com/ljm000/mylnmp/raw/master/go.sh" \
